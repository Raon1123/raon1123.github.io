...
- Christopher M. Bishp and Hugh Bishop. "*[Deep Learning: Foundations and Concepts](https://www.bishopbook.com/)*", Springer 2024. - PRML 저자분이 쓰신 딥러닝 책입니다. 보다 최신의 모델을 이론적인 측면부터 다루고 있습니다.
...
- A. Torralba, P. Isola and W. T. Freeman "*[Foundations of Computer Vision](https://mitpress.mit.edu/9780262048972/foundations-of-computer-vision/)*" - 컴퓨터 비전을 공부하다보면 쌓아올린 결과를 바라보게 됩니다, 그렇지만 가장 기저에 있는 이론부터 CNN까지 차근차근 설명하고 있는 책입니다.
